...
einem ersten Schritt die Daten von GERIT gescrapt werden.

Dies geschieht mit: TODO

Weiterhin müssen die
[DESTATIS](https://erhebungsportal.estatistik.de/Erhebungsportal/informationen/statistik-des-hochschulpersonals-670)-Daten
heruntergeladen werden. Diese können hier gefunden werden: TODO

Liegen die Daten vor, werden sie zusammengespielt. Da ein direkter
String-Match der Lehr- und Forschungsbereiche nicht immer möglich ist,
wird auch hier auf den AI-Match-Workflow zurückgegriffen. Dies erspart
uns das jährliche Anpassen von Regex-Patterns beim Matching und
harmonisiert so den Workflow.
